...
public class Demo {
    ...
    static void opg2() throws ContainerAlreadyBookedException {
        try {   
            CargoShip c = new CargoShip("MørskT13", 4, 3);
            c.addBooking("62938", 0, true, 2, 1);
            // tjek for at se om det virker som forventet
            // c.addBooking("62938", 0, true, 2, 1);
            // c.addBooking("62938", 1, true, 2, 1);
            // c.checkAddBooking("89647", 2, true, 2 ,1);
            c.checkAddBooking("89647", 2, true, 3 ,0);
        } catch(ContainerAlreadyBookedException e) {
            System.out.println(e.getMessage());
            System.out.println(e.requestedContainer());
        }
    }
